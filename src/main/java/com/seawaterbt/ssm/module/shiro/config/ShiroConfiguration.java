package com.seawaterbt.ssm.module.shiro.config;

import com.seawaterbt.ssm.core.constant.AlgorithmConstant;
import com.seawaterbt.ssm.core.shiro.manager.DefaultHeaderSessionManager;
...
import com.seawaterbt.ssm.module.shiro.realm.UserRealm;
...
public class ShiroConfiguration {
    ...
    public HashedCredentialsMatcher hashedCredentialsMatcher() {
        ...
        //散列算法:这里使用MD5算法;
        hashedCredentialsMatcher.setHashAlgorithmName(AlgorithmConstant.MD5);
    ...
    /**
     * 这三个地方导致事务失效，需要谨慎,此处注意Spring Bean 的创建顺序
     */
